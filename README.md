# Go/Golang package for parsing user agent strings [![GoDoc](https://godoc.org/github.com/adim/useragent?status.svg)](https://godoc.org/github.com/adim/useragent)
...
```
go get github.com/adim/useragent
```
